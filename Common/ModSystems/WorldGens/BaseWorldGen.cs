...
public abstract class BaseWorldGen : ModSystem {
    ...
    public override void SaveWorldData(TagCompound tag) => tag[$"{Romert.ModName}:{SaveName}"] = GensBool;
    public override void LoadWorldData(TagCompound tag) => GensBool = tag.GetBool($"{Romert.ModName}:{SaveName}");
