...
public class SlimeBubble : ModProjectile {
            ...
            if (Projectile.ai[2] > 0) {
                ...
                if (npc.active) {
                    ...
                    if (Projectile.ai[0] % 25 == 0) {
                        npc.AddBuff(BuffID.Slimed, 45); Projectile.ai[0] = 0;
                    }
    ...
    public override void OnKill(int timeLeft) {
        ...
        for (int i = 0; i < 5; i++)
            Dust.NewDust(usePos, Projectile.width, Projectile.height, DustID.BubbleBurst_Blue, 0f, 0f, 0, default, 1.2f);
    }
}
